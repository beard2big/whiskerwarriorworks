...
![Diagram that shows the components of an Azure resource name.](https://github.com/MicrosoftDocs/cloud-adoption-framework/blob/main/docs/_images/ready/resource-naming.png?raw=true)
...
![Diagram that shows the scope levels for Azure resource names.](https://github.com/MicrosoftDocs/cloud-adoption-framework/raw/main/docs/_images/ready/resource-naming-scope.png)
